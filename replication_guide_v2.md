...
Place a 1-meter reference (meter stick) at the athlete's plane of motion.

Measure the pixel width of the reference in the camera feed.

Update PIXELS_PER_METER in the python/ scripts.
